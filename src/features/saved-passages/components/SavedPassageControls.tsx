          ...
          {isEditing ? (
            ...
            <>
              <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                ...
                <p className="text-xs font-medium text-slate-500">{savedDateLabel}</p>
              </div>
              <div className="flex flex-wrap gap-2 text-xs font-medium">
                ...
                <span className="rounded bg-slate-100 px-2 py-1 text-slate-700">{sourceLabel}</span>
              </div>
            </>
          )}
        </div>

        <div className="flex flex-wrap gap-2 border-t border-slate-200 pt-3 sm:justify-end">
          {isEditing ? (
            <>
              <button
